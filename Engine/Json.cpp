...
namespace nu::json {
    ...
    bool Read(const value_t& value, const std::string& name, struct Vector2& data, bool required) {
    ...
    bool Read(const value_t& value, const std::string& name, struct Vector3& data, bool required) {
        // check if the value has the "<name>" and is an array with 2 elements
