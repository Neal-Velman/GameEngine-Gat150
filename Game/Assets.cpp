...
namespace Assets {
    ...
    std::shared_ptr<nu::Model> enemyModel = std::make_shared<nu::Model> ( std::vector<nu::Mesh> { enemyMesh, enemyMesh2, enemyMesh3 } );
    ...
    std::shared_ptr<nu::Model> enemy2Model = std::make_shared<nu::Model> ( std::vector<nu::Mesh> { enemy2Mesh, enemy2Mesh2, enemy2Mesh3 } );
